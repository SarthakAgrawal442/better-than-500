...
//   onSubmit: (result: any) => void; // Change type to 'any'
// }

// const presets = [
//   { name: "S&P 500 (avg)", returnRate: 7 },
//   { name: "Vanguard Total Stock Market ETF", returnRate: 7.1 },
//   { name: "High-Yield Savings Account", returnRate: 1 },
// ];
...
//     setResult(etfResult);
//     onSubmit(etfResult); // Pass the result to the parent
//   };
...
//             type="text"
//             name="name"
//             placeholder="e.g. ETF, Mutual Fund"
//             className="w-full border rounded-lg p-2"
//             value={form.name}
...
//             type="number"
//             name="returnRate"
//             placeholder={`e.g. 7 (default S&P 500)`}
//             className="w-full border rounded-lg p-2"
...
//         <div>
//           <label className="block text-sm font-medium text-gray-700 mb-1">
//             Annual Fees / Commission (%) — Optional
//           </label>
//           <input
//             type="number"
//             name="feeRate"
...
//             <div>
//               <strong>{result.name}</strong> at {result.userRate.toFixed(2)}%
//               effective return (after {result.feeRate}% fees):{" "}
//               <span className="text-green-700 font-bold">
//                 {formatCurrency(result.userFV)}
//               </span>
//             </div>
//             <div>
//               S&P 500 at {result.sp500Rate}% return:{" "}
